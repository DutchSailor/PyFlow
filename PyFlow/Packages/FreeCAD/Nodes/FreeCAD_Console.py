...
class FreeCAD_Console(NodeBase):
	def __init__(self, name):
		...
		self.warn = self.createInputPin('warning', 'BoolPin')
	...
	def compute(self, *args, **kwargs):
		...
		if self.warn.getData():
			FreeCAD.Console.PrintWarning(str(self.getName())+":"+str(self.entity.getData())+"! ")
		else:
			FreeCAD.Console.PrintMessage(str(self.getName())+":"+str(self.entity.getData())+"! ")
		self.outExec.call()
